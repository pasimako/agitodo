...
SOURCES = (
    ...
    (
        join_paths(SRC_DIR, "css/style.css"),
        (join_paths(DEBUG_DIR, "css/"), join_paths(RELEASE_DIR, "css/")),
    ),
    (
        join_paths(SRC_DIR, "favicon.ico"),
        (join_paths(DEBUG_DIR, ""), join_paths(RELEASE_DIR, "")),
    ),
    (
...
def build(UGLIFY=False):
    ...
    if UGLIFY:
        uglifyjs(
            join_paths(RESOURCE_DIR, "script.js"),
            join_paths(RESOURCE_DIR, "script.js"),
            verbose=True,
        )
